        ...
        <div v-if="type === 'personal'">
          ...
          <table cellspacing="0" class="tableList" width="100%">
            ...
            <tr>
              ...
              <td rowspan="5" style="width:10%"><img :src="formData.staffPhoto" style="width:155px;height:218px"></td>
...
<script>
import { getEmployeesInfoAPI as getPersonalDetail, getEmployeesJobInfoAPI as getJobDetail } from '@/api/employees'
